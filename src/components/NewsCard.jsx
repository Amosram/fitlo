...
const NewsCard = ({id, title, brief_description, image, titleBar}) => {
  return (
    <Link className='text-slate-900 cursor-pointer border pb-2 shadow-md rounded-2xl bg-orange-100' to={`/news/${id}`}>
        <div className='relative'>
            <img src={image} className='mb-2 rounded-2xl' />
            <h3 className='text-orange-900 text-bold mb-2 pl-2'>{title}</h3>
