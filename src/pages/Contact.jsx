    ...
    <section className='text-slate-800'>
      <div className='mb-10'>
        <div className='flex justify-center mb-10'>
          <h1 className='text-3xl text-orange-900 border shadow-sm px-3 py-1 rounded-2xl font-medium w-fit my-6 '>Contact Us</h1>
        </div>
        ...
        <div className='grid lg:grid-cols-2 gap-10 sm:mx-6 lg:mx-0'>
          <div>
            ...
            <form className='flex flex-col items-start gap-4'>
              ...
              <button type='submit' className='bg-slate-900 text-white px-3 py-2 rounded-xl hover:bg-orange-900 duration-100'>Send Message</button>
            </form>
          </div>
          ...
          <div>
            ...
            <div className='flex flex-col gap-6'>
              <div className='flex gap-4'>
                <Link>
                  <FaSquareInstagram className='bg-white hover:text-orange-900 shadow-md border w-10 h-10 p-2 rounded-full'/>
                </Link>
                <Link>
                  <FaFacebook className='bg-white hover:text-orange-900 shadow-md border w-10 h-10 p-2 rounded-full'/>
                </Link>
                <Link>
                  <FaXTwitter className='bg-white hover:text-orange-900 shadow-md border w-10 h-10 p-2 rounded-full'/>
                </Link>
                <Link>
                  <FaLinkedin className='bg-white hover:text-orange-900 shadow-md border w-10 h-10 p-2 rounded-full'/>
                </Link>
                <Link>
                  <FaYoutube className='bg-white hover:text-orange-900 shadow-md border w-10 h-10 p-2 rounded-full'/>
                </Link>
              </div>
              ...
              <div className='flex items-center gap-3'>
                ...
                <div>
                  ...
                  <p className='text-sm text-slate-600'>fitlo@gamil.com</p>
                </div>
              </div>
            </div>
          </div>
